...
| Dinero v1.x                 | Dinero v2                                                                              |
|-----------------------------|----------------------------------------------------------------------------------------|
| `d1.toFormat(format)`       | [`toFormat(d1, ...args)`](/docs/api/formatting/to-format)                              |
| `d1.toObject()`             | [`toSnapshot(d1)`](/docs/api/formatting/to-snapshot)                                   |
| `d1.toUnit(...args)`        | Dropped, [see replacement](#replace-tounit-and-toroundedunit-with-tounits-or-toformat) |
| `d1.toRoundedUnit(...args)` | Dropped, [see replacement](#replace-tounit-and-toroundedunit-with-tounits-or-toformat) |
...
## Replace toUnit and toRoundedUnit with toUnits or toFormat

Dinero.js v2 no longer has a built-in `toUnit` and `toRoundedUnit` functions. Use [`toUnits`](/docs/api/formatting/to-units) or [`toFormat`](/docs/api/formatting/to-format) instead.
