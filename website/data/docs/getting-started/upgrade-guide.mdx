...
| Dinero v1.x                 | Dinero v2                                                            |
|-----------------------------|----------------------------------------------------------------------|
| `d1.toFormat(format)`       | [`toFormat(d1)`](/docs/api/formatting/to-format)                     |
| `d1.toObject()`             | [`toUnit(d1)`](/docs/api/formatting/to-unit)                         |
| `d1.toRoundedUnit(...args)` | [`toRoundedUnit(d1, ...args)`](/docs/api/formatting/to-rounded-unit) |
...
function createIntlFormatter(locale, options = {}) {
  ...
  return function format(dineroObject) {
    return toFormat(dineroObject, formatter);
  };
}
