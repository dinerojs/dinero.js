...
The [Paypal](https://www.paypal.com/) payment platform provides APIs to process payments and manage orders. Unlike most platforms, it expects a money representation with an amount in major currency units. You can use [`toUnit`](/docs/api/formatting/to-unit) to retrieve this value.
