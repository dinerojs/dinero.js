...
For a more complete overview, check the API reference for `[createFormatter](https://www.notion.so/createFormatter-f08201120f45404cb817b3caeb23b609)`.
...
Another useful usage of `toSnapshot` is transport and storage. To do so, check the advanced guide on [transporting and restoring](https://www.notion.so/Transporting-and-restoring-7859a65186804ca08ff17b8aa9ea38b2).
