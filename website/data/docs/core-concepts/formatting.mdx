...
If you're formatting many objects, you might want to reuse the same transformer without having to pass it every time. To do so, you can build your own higher-order function to build formatters.
