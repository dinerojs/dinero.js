...
To support Internet Explorer 11, you can use [polyfill.io](https://polyfill.io/). Add the following script to your page to conditionally load polyfills.
